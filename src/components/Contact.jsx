export default function Contact() {
  return (
    <section
      ...
      id="contact"
    >
      <div className="max-w-2xl mx-auto glass-card rounded-2xl p-12 border border-white/10 relative overflow-hidden reveal in-view">
        <div className="relative z-10">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <a
              className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-primary/90 hover:bg-primary backdrop-blur-md text-on-primary rounded font-body-md text-body-md transition-colors font-medium border border-primary/20"
